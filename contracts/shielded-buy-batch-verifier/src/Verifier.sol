...
uint256 constant VK_HASH = 0x15a1e5e48d24a86964e25789c5e4d1f9bdb428b829e92e669b02fbf180b7ec2c;
library HonkVerificationKey {
    function loadVerificationKey() internal pure returns (Honk.VerificationKey memory) {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            ql: Honk.G1Point({
               x: uint256(0x0197086ac1a8e0a74031e87aba376d9e8f499d35d7310bfc3e73ad8e66273dd0),
               y: uint256(0x044e22834b54c4e53f9f7515e244fc76fb9e94c7256515f8d2ae0522a39af528)
            }),
            qr: Honk.G1Point({
               x: uint256(0x00ca04b5a14b76b2b6d6f62ce0f2ca98c6178facfbc0b6cf532a6f71aee19463),
               y: uint256(0x19bb40c1b932ce07f7f344d3a38c054b99068fd0f1a9ec49b55ec408331c0b51)
            }),
            qo: Honk.G1Point({
               x: uint256(0x2b864c1c4ab033aa009e36acc8036adcd92bfb5eac1db16e8b5dc2417d4216ad),
               y: uint256(0x168e30521cf3bec3bccba278a08162c40f89f9ba6b84cf5a5752250334b62095)
            }),
            q4: Honk.G1Point({
               x: uint256(0x150e101def846ff12f7cb059c7610d1d506dfc902a66536506ae8e5adc4c18d0),
               y: uint256(0x14cb164450ed7ebb35270d361fe4626841389bbf525d47a30d48d9af9f721919)
            }),
            qm: Honk.G1Point({
               x: uint256(0x255ada37f5b9ea8563b7a75aa280ea72e8ca23f7447aff4c48bad382aa1e7ab4),
               y: uint256(0x146a51b8000a454c8acb2fc01eeb2bf3d138ff1ace1cd01a73ef17d3e4d1cb52)
            }),
            qc: Honk.G1Point({
               x: uint256(0x0240bd8053d19b19f20d1e4383b2c03df023d9d603f2cd302343d1f4c4048eeb),
               y: uint256(0x27cfe5b73553e6023f32d42ab4a6a41b63612e22a21ef656923ad8f83cddb1d4)
            }),
            qLookup: Honk.G1Point({
               x: uint256(0x1614d58cb04ad5f31f69b87ef5c5b0f9acb5f63e27b2c8d735d10088f54a40b4),
               y: uint256(0x29277c661c4df198a9a5970248f8d51bfb6ab259aa0c329f4306ff2052690eb8)
            }),
            qArith: Honk.G1Point({
               x: uint256(0x2bb2463d8951fa8ead359aca057a7c3978e8fb0bef7ddf0ee61c05c7aa896fee),
               y: uint256(0x1d87fc3ca5ee720517860204747a4ac2fbba2f96c3e2acec715c203e1aa7e3fa)
            }),
            qDeltaRange: Honk.G1Point({
               x: uint256(0x004b389a0090ed838b116699090ac216ce6ddd6196ef577756e277ad47c01aa1),
               y: uint256(0x305f788aa738c395dbd90d37bb396f66744e5cd17385840e4aa3684c8c005101)
            }),
            qElliptic: Honk.G1Point({
               x: uint256(0x17999447478cfb4c75c30b157c481c61a90ac11db5fd7056199825aa1db02c73),
               y: uint256(0x02d131a2ec3e098cb9657c631020a99a020c49039f14b613f33858e00520b41e)
            }),
            qMemory: Honk.G1Point({
               x: uint256(0x15ec772cd97489cd9f5206f42425c9106a85eb7d0d2c4496b44255eea1a1340e),
               y: uint256(0x07a307c34db610f5bb5db53e3f95e5b3d5838109736231e0ab54bb0a7fa018fa)
            }),
            qNnf: Honk.G1Point({
               x: uint256(0x0e54301d761884b7c9a1f9b5adbe5f4be6f62ac3990388ccb568945a4d14b466),
               y: uint256(0x127ade00cbe7807428c861481d16919413f0daf86265635bc4caa1b71741f23c)
            }),
            qPoseidon2External: Honk.G1Point({
               x: uint256(0x30119ca2a0865acfdb22c77a756a79a6f71eb0299ce8ab2d8f6705a1bee7fb09),
               y: uint256(0x1cd8c4f10e166ab10304dd50e068b0ded4678d61246424d2b7dfdd063c586f24)
            }),
            qPoseidon2Internal: Honk.G1Point({
               x: uint256(0x26cc8308d0ab2ccb636935d876648172fb24d59361e4178f77e72903a5630915),
               y: uint256(0x1de9bbd4b7a5968288d110beaa15e51b7504ea8e283e92e4f9b8919a358005c9)
            }),
            s1: Honk.G1Point({
               x: uint256(0x1766c395252886dfdbd7bdd336a9a10dcb5f44d810c68724486f970030e6b14e),
               y: uint256(0x08ca36998e3f1c00e1993dd2ac9722cf8c67fcbca796489ff00c76beace90aa7)
            }),
            s2: Honk.G1Point({
               x: uint256(0x2e62bee3818099d5b4da71acb870e5908b66af150365d543281e704e9b7ce255),
               y: uint256(0x1058e7f51c5374eacb568d056a1d74fbff6da87c9f0add90191212965f59ee1c)
            }),
            s3: Honk.G1Point({
               x: uint256(0x2db75d1ca5f9290f53e76cdaa4fc8a80d61870171ade993d0fcd9f13f5cf8cde),
               y: uint256(0x20fb6e438361e1c9dd90efd2d92547084267181df85c675d7d5b041a1ec73470)
            }),
            s4: Honk.G1Point({
               x: uint256(0x156a7a46d549b11a41130f555ec07be9df8de2c2c442c45319f50c8c7087f9da),
               y: uint256(0x032ed6472f30fb1552ff14f2eda178c74806baaa9740f110ede6aeb4c7121e0f)
            }),
            t1: Honk.G1Point({
            ...
            t3: Honk.G1Point({
               x: uint256(0x14f56d003ecfdd886a97b69c704ba5d7a8e7487c53d088e99c012a77f85eb546),
               y: uint256(0x27d696ffd0b07ab31e78091103c12365f3f33dc6a8c407cbc444dc34cc36dddf)
            }),
            t4: Honk.G1Point({
            ...
            id1: Honk.G1Point({
               x: uint256(0x1b8960561072840672f064fe7aa7cc2814efecdba0ef890a103eab4eb6196772),
               y: uint256(0x2bbd76541074b9c90ca55a2a3c1e20873bbca1479d87cd03ad10839db71c247e)
            }),
            id2: Honk.G1Point({
               x: uint256(0x13b30e28ac13a5fe289283f9563ee5d878f5e2e6ceae33789d8a4b9066dac321),
               y: uint256(0x04533a86107d97947d7a77cf5b55f7bce21d7570fba8f61b95e3c97bf2738c17)
            }),
            id3: Honk.G1Point({
               x: uint256(0x0194f3e6cc2e0379cb91c2da254289e2e7f85709616ea09374357ce8ffa08cbe),
               y: uint256(0x15d836e828b1e353aec6b331073856ff7040094745b1dbf0f47bc49475b67755)
            }),
            id4: Honk.G1Point({
               x: uint256(0x1085e86da30bb32bc84c3adaab7432863f06da097ea27602d70d677fa1b6e1a1),
               y: uint256(0x09f7fb62ad57dd422b3b4a65e97464c1064ec9543d5a8ecb181a1751ba4cac96)
            }),
            ...
            lagrangeLast: Honk.G1Point({
               x: uint256(0x26716eb53293e13073087ba816a4c768ffca3c22366b8a31b877856f2a74436d),
               y: uint256(0x1a5e8a6b013557e9f95aac61079399966967cad84c700fc5842c4df7d8428e95)
            })
        });
        return vk;
    }
