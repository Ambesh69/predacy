...
uint256 constant VK_HASH = 0x25fa8b078976df751b6b48f2b3bd4d1590b34e37b8b354d51b7fcb4ad97ef57f;
library HonkVerificationKey {
    function loadVerificationKey() internal pure returns (Honk.VerificationKey memory) {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            ql: Honk.G1Point({
               x: uint256(0x115334801f296935fc33136ee7e78b209fd843f1dd1fa520f70aefb468169ecd),
               y: uint256(0x2f53537b2732afc24cd792058c9cdfdf6278dbd3b2a1b2f99f0802255cc13f34)
            }),
            qr: Honk.G1Point({
               x: uint256(0x0e8ce891251054f5c3c4b3296b3559d5d6fb77aabfb0bac16628c4014c703b4b),
               y: uint256(0x00769989a59dff625ad118bac52016e542013821d477b3f3f81f0fd70f1b9571)
            }),
            qo: Honk.G1Point({
               x: uint256(0x20063319b66955919dc02bd3394f3865a7fca1e3e5094b90f27bd7c8434b7002),
               y: uint256(0x20215679dd117602b37a9448fd9c7204459e383bd3c74dd0dcd429b6cf30c6a3)
            }),
            q4: Honk.G1Point({
               x: uint256(0x0007966b08d25f13548c809f9483208c6d9f8647c476d7a3c15ea806f1d378b7),
               y: uint256(0x1a4f9c0184d201e1733976d685d90c852d43abce17bf0e23f30851cbfa13ffab)
            }),
            qm: Honk.G1Point({
               x: uint256(0x26404ff60042d9f3a362a168b8ab6855d845a742825402ff19e5092f8062efdf),
               y: uint256(0x2c41ea2512fdbaa9acdc6411f821ef7f15e94c70e6c489978a0bd6164b6e1b2a)
            }),
            qc: Honk.G1Point({
               x: uint256(0x069a867723caeeffc7c8a4f485bebd89c0a3ee49d39bb56aa1b9756479b462fb),
               y: uint256(0x3039c784a49dcc950c0f88134557d91d4111ce83050b7c4170b6bf3052b12569)
            }),
            qLookup: Honk.G1Point({
               x: uint256(0x22272d2d714be3ab810add49d7844038f5c444fd9ef825486d6d25316d97bb66),
               y: uint256(0x08dfdc1348594e72f1249528ae69d491972933d2d74dd824312984a20a93727a)
            }),
            qArith: Honk.G1Point({
               x: uint256(0x1b8724ff8746b48e16050147ec85760000c8c0bb2a077bc9e07f69c834edca22),
               y: uint256(0x1273692e6136f335d6781c8f753f00a30b32986ee95abc03decbe028246600f6)
            }),
            qDeltaRange: Honk.G1Point({
               x: uint256(0x113566c2fde8f93f673556a04722200c08d4ea2005d3ac6066078e549381aabc),
               y: uint256(0x0bd20dd5b6ab7a5c7afcd6adb26b59bbfd8c4cbc77ac3d65190db7f6b8eb6a1d)
            }),
            qElliptic: Honk.G1Point({
               x: uint256(0x064645f8088443f2f473716b17e2b5b4e5e097be67c8944f5e6487bfd0b6c3d2),
               y: uint256(0x00884a0017a41014fffa4520d70d73e47591ae1510d3f6dcd3dd4719742dd179)
            }),
            qMemory: Honk.G1Point({
               x: uint256(0x02bc12f4fea5ed4ea166f52aee8ea3d5d4ced90d02b52b0b3041834f109c304e),
               y: uint256(0x2611be57d9ecc8bc688d2c1346db369d244e5fae7b25ed4803a2af0934f21646)
            }),
            qNnf: Honk.G1Point({
               x: uint256(0x1f691287912a3d76b212abc7274a8135bf76d30faf33fa342fb1676c0780020e),
               y: uint256(0x04ae14f938885b56ae6f3d90c42c756738866a511f0e2af8843d9059637f5ca5)
            }),
            qPoseidon2External: Honk.G1Point({
               x: uint256(0x0dbb71d4f0b6070febc67c6af9bce1146453f7a476edfa4dcc0c6ed5f62d6721),
               y: uint256(0x2d08211f5be4440cf1f41842c51ca79736280a6cacd5104611d0d05909b88cad)
            }),
            qPoseidon2Internal: Honk.G1Point({
               x: uint256(0x2a4554049704d1274dc69a95d0f5c29a43c27616484d4d6c8b4dca8b41783b56),
               y: uint256(0x2bd73e606272bd13d4e82ffe26278732da0e6cce6daf578576a7352e3519ae72)
            }),
            s1: Honk.G1Point({
               x: uint256(0x04f51d3daca1a017ea0ee9b9612227b6d8c7f259e67b0405b2190099677bf0ab),
               y: uint256(0x2efcef3b3f4716bec1ff2361b4c56d44167eeea65129234bb637fe3af19a4afa)
            }),
            s2: Honk.G1Point({
               x: uint256(0x04c0cb41bfd242148b301f119ffb81851451372aa4c6728bd1f3212dd4f0d399),
               y: uint256(0x1fb506bbe39423cf9690e7d751b1296bda62ba76d23afde658538637b77820ef)
            }),
            s3: Honk.G1Point({
               x: uint256(0x29c94fac23ef2cf616c2c2eda9c62e1d27f5d9d474c071affeeb3c44d24c3b5d),
               y: uint256(0x11f98f317d02eec4144e81b6b17f7a0161897b86478d2d41831bc274708a5403)
            }),
            s4: Honk.G1Point({
               x: uint256(0x29fec9b627c0ef3bcb02c33b1d9d5c21301917803bed2feaaea137d1311edb1a),
               y: uint256(0x288e2a6335c3c9d78e12193ae97222adc2d139add1d2b1e2d7382e3d07ed94f4)
            }),
            t1: Honk.G1Point({
            ...
            id1: Honk.G1Point({
               x: uint256(0x11e6545cc10988f79857abca2fd5aeb3ce02f9114cb6afaf1751be51ffc93fc8),
               y: uint256(0x04fdcb17207be6b532e65bb6ee084f59a9523539491c62cd06dc3a950bd60c5a)
            }),
            id2: Honk.G1Point({
               x: uint256(0x1c428e2cf60177b93e570d017e91f75847810c816dca6ae4bed66cc75f6922ab),
               y: uint256(0x117d0817e3dc5431800f7122a6e67a78ef2eb05ec4377de6aa0de62a07e9ca98)
            }),
            id3: Honk.G1Point({
               x: uint256(0x060ac424543c5ccc8cda77a749bcf3b6d6cce1ca35d11bcf91475a2fb3f8faf8),
               y: uint256(0x204b93c9126f8ecd4ddbe2dd4eb5a592c9d1f19205c62d701cd0d49e400b5240)
            }),
            id4: Honk.G1Point({
               x: uint256(0x0c9ef49ca6a0ac7c4de28237b7ccfcc69e8ec6697e6abd51fa3a7cf11b78eb5f),
               y: uint256(0x0f7f898c8fdb65c3ac949658a9fe54dfbf0aa6076471a3d2a9d2fa4d60398bb7)
            }),
            ...
            lagrangeLast: Honk.G1Point({
               x: uint256(0x2ab1191c62c660858a7299b3bcf3e28ee9a373e534a56c6d7caa86520c5f3026),
               y: uint256(0x184b315e401d217c91468e6f74b0420b7b81f466853e7723e36acb926ee80e22)
            })
        });
        return vk;
    }
