...
uint256 constant VK_HASH = 0x091cb98950a9ed50e3f7a2edec8e6b001de16ae47c7877d351dc10af5720f89e;
library HonkVerificationKey {
    function loadVerificationKey() internal pure returns (Honk.VerificationKey memory) {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            ql: Honk.G1Point({
               x: uint256(0x27c22ed571026efa6b2cd6edfc1a00859b1277daca8decadd68e8ca8d1074255),
               y: uint256(0x2cd190c57fab3c0186554562e9fe013a22edf687c1bd8098156491c184861e6b)
            }),
            qr: Honk.G1Point({
               x: uint256(0x0d7e5c6695443af564fa87d15cff6414c91773c5954cfd8c1c037a1706a22c8f),
               y: uint256(0x2978be61d6279dcd91ee2b5a187f0f9d2eccd0fe8828821df983358494f279d7)
            }),
            qo: Honk.G1Point({
               x: uint256(0x1d69823ed8ad1daa03793e54d77e25bccf12500b00d5a3db3f16d0dcbb160c2f),
               y: uint256(0x0146543cc8a5f72c9588fd559dc54065e6a62e922a164b360789ca11c0871af1)
            }),
            q4: Honk.G1Point({
               x: uint256(0x1238c0c33abe80c7edc8d982045e9876599484e27a27709f6012d9a8f01394ad),
               y: uint256(0x066b772229eced36f5593a3eb3d65567e8ef90e3403571aedd2e3b5d48e0768d)
            }),
            qm: Honk.G1Point({
               x: uint256(0x298e3184a4e609e9dda01ba9af02a7f319a48b7716ec87a815b2e99c8fca8a77),
               y: uint256(0x0c75b4cd5fd106f4ac1981801678ae6798781cb1cb4318378c0f7f24eef6dae4)
            }),
            qc: Honk.G1Point({
               x: uint256(0x11ac65f2b8b008fd117e6c178d3207e58493f6c1ca1bf1269a2f40e316e8fa36),
               y: uint256(0x1cf54507243c86efff049abd7714a75a054012358c0effd91d42ee5b153f5e9e)
            }),
            qLookup: Honk.G1Point({
               x: uint256(0x1bafd76b1ec39551b044ba87c6561d0a3132b572a5d596ae377e925aed147ebe),
               y: uint256(0x0bd35463528ba9816d90cafec01c4721d5c52d7ee338ed477cb2fcf12303fefa)
            }),
            qArith: Honk.G1Point({
               x: uint256(0x0e08191da2ea5b8d63fd371cd3458df00218990cefe113b37efa46032e96ceec),
               y: uint256(0x1f250f8e662afc65e42c42f4ff04bdfa2dbe2a44c3b257d19d9752c194196aaa)
            }),
            qDeltaRange: Honk.G1Point({
               x: uint256(0x1b29394d57d2c28b6122934521c07438038b053af31b5cbf39bf4a9e2f398266),
               y: uint256(0x168f75cc95694a4194c2f84ad8b5b0ec916a6d0b68926e7731e60c9b06376477)
            }),
            qElliptic: Honk.G1Point({
               x: uint256(0x0dc9a790dd0644275512f4efd85061de990932451b2a3a3f32e70a65775ff793),
               y: uint256(0x0954aaf41979c009eddfb495b0e47ae3b00eba152f1f84b2958ad098dd60b1c0)
            }),
            qMemory: Honk.G1Point({
               x: uint256(0x104c3c6f5cd8991b56d03a8c803cc8408d2986dec25218592aab0004257e590b),
               y: uint256(0x1a771edc2c35ce5c4adf43c5ef37501590681fe3b308d38d07f2232b6342b0df)
            }),
            qNnf: Honk.G1Point({
               x: uint256(0x2eab2baba5a6e67ba62b4d68039ebc3426975deeb0adc122ec339cb3c6dd03be),
               y: uint256(0x0cf2cc39c41fa8fb9e108a3aa0fc703a1664bb0a3503decf8385955b5db4e6cc)
            }),
            qPoseidon2External: Honk.G1Point({
               x: uint256(0x13234bcff73916579e930caf111a584b01bf77f96f3136eec3b5cbc31ba1751b),
               y: uint256(0x08934e71b99ca6f8649be3cc6d3cc893666d5e71b4c2bb24a7137a23078e603b)
            }),
            qPoseidon2Internal: Honk.G1Point({
               x: uint256(0x17077edf5c1b82d32fc17978fac7b158e91cbe22b8a66b7fcd7e5782254035a9),
               y: uint256(0x0c46b6d3a392628d5889d62812f77db878b525636fc400bb7bfb2961d972bd85)
            }),
            s1: Honk.G1Point({
               x: uint256(0x0728380754697a58640f254cf3e050b59044462f6ac89641358dccc59acdbf50),
               y: uint256(0x0d842f0b158fbce0650ba1ecfa92bf0618ab6e350ae303d68addd004d757c6ef)
            }),
            s2: Honk.G1Point({
               x: uint256(0x1f789f1e8b5a8a18d12f8e009a23055d1492b5cc5b2255ca55a05c08cd1034fd),
               y: uint256(0x2166e5a23051aef0f3b95add371c7511468480fa496690cf0a138fca992e55e4)
            }),
            s3: Honk.G1Point({
               x: uint256(0x237ac86f95699e4a2074ae54bf0df3e6be4927877cba270ddeecd5972f2b8d54),
               y: uint256(0x143bc86b8a17a6615410ce1f52cf665a48f1cdebb6929b9172563d283ba36488)
            }),
            s4: Honk.G1Point({
               x: uint256(0x2dae15ed64139e1df8c66d3799317a4a64bd5a03e475e296585e20c15e4b6bc4),
               y: uint256(0x17a1a4111dd22a68671ee5b9cde614c4e5b9cbcd4ec1d7cc7d0c9749ffe06b15)
            }),
            t1: Honk.G1Point({
            ...
            id1: Honk.G1Point({
               x: uint256(0x0edd0bb4329b3eb3aa5c0c6a3bda622ddf62bd66fb3ebb9e5d11e97c65fbb898),
               y: uint256(0x2e328bb89a516501a17d87970af2c31b1cbe921e6ec0777be7143a27a905f43e)
            }),
            id2: Honk.G1Point({
               x: uint256(0x078c69cd14b91edb1aa861cf306a7c3dc07b594096c062c9383871f7af0ace1c),
               y: uint256(0x17deaf342779fa9826b26541e89d362bfc65cdfda86259265364b7355cfa8ae3)
            }),
            id3: Honk.G1Point({
               x: uint256(0x0fa277860e8f9d544b21b029e09d21b2924a6b824a7eb86041669e30b5e5fa27),
               y: uint256(0x1ec5527bfb90c49c63b51ebf358502b7a8e70357fcaea239e9e54892e33d8067)
            }),
            id4: Honk.G1Point({
               x: uint256(0x07f3179eb8734559867fc33100d024e411300af3fb68d4e07c85bce7273dea4a),
               y: uint256(0x18df50d5240f0b3377721058f6ee6f8d095937f73314e60b8b2aed095f9690e2)
            }),
            ...
            lagrangeLast: Honk.G1Point({
               x: uint256(0x15ff256ff29a7b5031be6f291af3118442bcfd4bc5b1e8db72e43188767718a1),
               y: uint256(0x0b2092bb64a007a2dac8ca493fdf1e5a1240d2864df070b45aa865b9ececcdbc)
            })
        });
        return vk;
    }
