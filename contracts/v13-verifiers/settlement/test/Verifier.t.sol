...
contract V13SettlementVerifierTest is Test {
    function testRealSettlementProofVerifies() public {
        ...
        command[4] = "../../../relayer/scripts/generateV13Proof.ts"; command[5] = "settlement";
