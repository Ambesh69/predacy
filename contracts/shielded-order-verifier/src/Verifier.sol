...
uint256 constant VK_HASH = 0x002cf537ffbd75ffa5af7b340d9827129347923fbba4c128bf7ec3542ed0fe0f;
library HonkVerificationKey {
    function loadVerificationKey() internal pure returns (Honk.VerificationKey memory) {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            ql: Honk.G1Point({
               x: uint256(0x22d4b3a20daa1bae436a3f854f9154711e12d51bc684c0ead8dc81097a6b2edf),
               y: uint256(0x13f7a015814ec9e1f90291e955457aa4cc476bfcbf271bfceae00b42935f5853)
            }),
            qr: Honk.G1Point({
               x: uint256(0x02fc05ac7e063631ee2ba55fd8e0c0163165e12c3dcf0782aca9726d6670d0ee),
               y: uint256(0x15af60b8f0bbae335241bcc6a6dd985ae15e50695a89e45a85e5a8a8459a9a8d)
            }),
            qo: Honk.G1Point({
               x: uint256(0x222d7b59cfa6dc9a1beff53279d218d2d55551dad48fa047372b9fed7a42c23e),
               y: uint256(0x031994aeb1d3da5796b4af598347a5c9cd7ea4a364b126b654d2cedddd74d1c5)
            }),
            q4: Honk.G1Point({
               x: uint256(0x19e9edd2195f63cd4c037c054c0fb2b8e6be5e33fce192f9b338db80ce250f89),
               y: uint256(0x15164b2430486da01acbc9d63ade524bc1c2db32d38febfac286801e36e57f37)
            }),
            qm: Honk.G1Point({
               x: uint256(0x0cf57321fb931cbad5278e132e3bc3d570e3888a38c8ff2ac6362501ac307215),
               y: uint256(0x18c0f237305755e9507e4c20e2b6e1ea901ebef404085804b364d64a5fbb6aee)
            }),
            qc: Honk.G1Point({
               x: uint256(0x2f0f07168dd9be8b1b3cf5b8e25d2081cf19bbb0b00f7eab0b3a7db85859384c),
               y: uint256(0x1fb44d88fd07533f282a887fed33c87a83f75b7c5de018a5d1d04058ff50af36)
            }),
            qLookup: Honk.G1Point({
               x: uint256(0x1bb3103523948ac231040402a8aa22264025492f26233e913f600552af673c22),
               y: uint256(0x2ec32093b6ab0e77d9b0ec4fb7bd1d64373e5058475761d406f0f395bd1761db)
            }),
            qArith: Honk.G1Point({
               x: uint256(0x2a51c8f61290dd099dcb5c1a6a854fce80eae41805f6bfeec3bedce79b18b3e2),
               y: uint256(0x08f9f6a56c83220b3f2583eef682bac70058df5f7bb99ca04994cc969bda7bfb)
            }),
            qDeltaRange: Honk.G1Point({
               x: uint256(0x283d7b39406ea07a3e7e65964f767e2bea8b5a15c79be4d22bc473a15e791023),
               y: uint256(0x1e8833f6e024a2295c10f179053bd6a03240d6c3e24e592b2a5269af4d6f03a1)
            }),
            qElliptic: Honk.G1Point({
               x: uint256(0x0ac8a5772ea5e7ebb3b47ab44a58667d1c9498e9df214d8ccf7aca1fa52904df),
               y: uint256(0x1517a06e5276198ef9af66b14e52a0056be811977579c7e884f4c22efc314285)
            }),
            qMemory: Honk.G1Point({
               x: uint256(0x29179c58a8835c7228dee9d3ae7081d4440c0acda73293e33250aadc9ccd7ff5),
               y: uint256(0x1555c3f1ab93693c3f98064a023200db9aa264f7065e58fc7f5c52c1deb52211)
            }),
            qNnf: Honk.G1Point({
               x: uint256(0x07902cbc156ee4efcbd1bf42fd69897537c5f832a92c89371d2cab228c3c71b9),
               y: uint256(0x2fa5a68e5bf3bc84ab6451c1508edaad64f8e0aca0f9a27151ef098da3576479)
            }),
            qPoseidon2External: Honk.G1Point({
               x: uint256(0x05ab75a181798757e29880a756197b25a49a4f3763923c793f2a0f38a6517390),
               y: uint256(0x0e653a85c34c1f4e3c13e2af020777e1a2323da2a50a428383fdb781ea8576a6)
            }),
            qPoseidon2Internal: Honk.G1Point({
               x: uint256(0x23d21a3c0daf2cfe87cbd4278b532e835b5e0c83f9c9b5961846e60a7d4f654b),
               y: uint256(0x261b4f4ed429e06a064a5eb2f7c69de57a8b610e1a72171d4dcb3a1a1b5f6d53)
            }),
            s1: Honk.G1Point({
               x: uint256(0x301e0b6e980962580d1ee7fe09070fb439ab3cac2cb06fc3be93f4b89b581b4a),
               y: uint256(0x0f628cd5d8cccf81a292430ec777508ac784a3966c74c8ee1e9dbe2b96fae678)
            }),
            s2: Honk.G1Point({
               x: uint256(0x14f5a2043a0411c7b9476490b63fdb6affcd3eca4d58907cd8c5eccaad56e96c),
               y: uint256(0x2c1fb3db8d7bd38f3d5080e5cca8082f05c185485f8d82e5c8f6afd8dd3c5ef7)
            }),
            s3: Honk.G1Point({
               x: uint256(0x2789129e877d6518d65b3f1385cc31f5cf34ae3c38eeac3786bf093514fed28a),
               y: uint256(0x13ba41efc4de07b0e0975d20613250c38a47f217a5f22bfcb4fe2519f425b9ec)
            }),
            s4: Honk.G1Point({
               x: uint256(0x29b8cbbac4ce12b487cf7f1d4e4c1c4c61df31ce6355e1bca381fa074acb41a6),
               y: uint256(0x0a231b83e32964d3803fb0ed14960bc445b213ca553f9910dd0178fa93c39112)
            }),
            t1: Honk.G1Point({
            ...
            id1: Honk.G1Point({
               x: uint256(0x063b8385a0500a7c8f0bbfb28328c2d406bbe44b356687eb1a63fa2e90ef678a),
               y: uint256(0x276503150e264728e849feae134931150767604164d694db3bc340ebf3220099)
            }),
            id2: Honk.G1Point({
               x: uint256(0x0534e7c1f6a98eef0b339bfee191aedf53f9abe962d386932e0c0b0dd501a8cb),
               y: uint256(0x163c3732a61ef90b05fdc70bc05f0cc137651eb939a97f307c46b36ce5483641)
            }),
            id3: Honk.G1Point({
               x: uint256(0x26cedad5f662e6625490c01261100146d4e93cd2315fda6dd77227c351c77d51),
               y: uint256(0x08d28bb90dd07b836140cdc323a26a6a34f34dd3a00813d169d21e9f495c3301)
            }),
            id4: Honk.G1Point({
               x: uint256(0x1683a661f055b395a8d6c2c5c48b06b83b5b11cebba5c8fcd559e91c47917483),
               y: uint256(0x296ae5994be70dcf3f649cdd4cff4272964756e6117846fb1311eb2ccb8e8a1e)
            }),
            ...
            lagrangeLast: Honk.G1Point({
               x: uint256(0x2a3c76a656fce64defb863c6db6ef5ae3a2062976aa890994c0c9dbc651e3945),
               y: uint256(0x234745e080e2ac9bf3375f68b1d7855798e6c3dd77aec513b7c0d172eb3b09a4)
            })
        });
        return vk;
    }
